...
const CoursePageWithGraphQL = compose(
  graphql(POST_QUERY, {
    name: 'postQuery',
...
const CoursePageWithDelete = graphql(DELETE_POST_MUTATION)(CoursePageWithGraphQL)

export default withRouter(CoursePageWithDelete)
